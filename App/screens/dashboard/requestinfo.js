    ...
    render() {
        return (
            <View style={BaseStyles.background}>
                <DashNav navigation={this.props.navigation} title="New Delivery" info="Confirm Delivery"  />
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{flexDirection: 'row',alignItems: 'center',marginBottom: RFValue(30)}}>
                        <Image resizeMode="contain" source={require('../../assets/icons/dot.png')} style={{width: RFValue(28),height: RFValue(28),marginEnd: RFValue(7)}} />
                        <View>
                    ...
                    <MediumText customstyle={{color: '#B2B8BD',fontSize: RFValue(14),textAlign: 'center',marginBottom: RFValue(24)}}>Estimations</MediumText>
                    <View style={{flexDirection: 'row',justifyContent: 'space-between',alignItems: 'center',marginBottom: RFValue(30)}}>
                    ...
                    <View style={{flexDirection: 'row',justifyContent: 'space-between',alignItems: 'center',marginBottom: RFValue(60)}}>
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate('Journey')} style={{...BaseStyles.button,width: '60%'}}>
                            <MediumText customstyle={{color: '#FFF'}}>Start Journey</MediumText>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={()=>this.props.navigation.goBack()} style={{...BaseStyles.button,width: '35%',backgroundColor: '#F75454'}}>
